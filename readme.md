# NSX-T 2.5.1 Configuration for Tanzu Kubernetes Grid Integrated edition (Formarly Enterprise PKS) Manual Installation
...
- This lab guide should be completed using the TKGI-Ninja-Baseline template. The `NSX-T Configuration for TKGI`[https://github.com/ModernAppsNinja/NsxtConfigForTKGI-LAG-NC5947] lab guide must be completed in your lab environment prior to procceding.
...
- [NSX-T 2.5.1 Configuration for Tanzu Kubernetes Grid Integrated edition (Formarly Enterprise PKS)](#nsx-t-251-configuration-for-tanzu-kubernetes-grid-integrated-edition-formarly-enterprise-pks)
  - [Overview](#overview)
  - [Prerequisites](#prerequisites)
  - [Installation Notes](#installation-notes)
  - [Overview of Tasks Covered in Lab 1](#overview-of-tasks-covered-in-lab-1)
  - [Step 1: Create T0 Logical Router for TKGI](#step-1-create-t0-logical-router-for-tkgi)
      - [1.1 Create VLAN Uplink Switch](#11-create-vlan-uplink-switch)
  - [Step 2: Create the TKGI Management Plane](#step-2-create-the-tkgi-management-plane)
